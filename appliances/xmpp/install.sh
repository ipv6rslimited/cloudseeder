...
echo
echo
(cd $HOME/.ipv6rs/appliances/xmpp/ && podman build -t xmpp . && podman run -d \
  --cap-add=NET_ADMIN \
...
echo
echo Make sure to login and make your admin account by typing:
echo prosodyctl adduser __ADMIN
echo
echo
